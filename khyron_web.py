...
Tu base de datos es el 'Contexto' proporcionado por MIS APUNTES. Prioriza esta información. Si es escasa, utiliza tu vasto conocimiento general sin restricciones.

Instrucción Clave: Sé 100% directo, conciso y técnico.
"""
